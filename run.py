...
# Number of epochs
parser.add_argument('-ne', '--n_epochs', type=int, metavar='', default=1000, required=False,
...
# Number of epochs for VI
parser.add_argument('-ve', '--v_epochs', metavar='', default=100, required=False,
                    help="default=100, \nNumber of epochs for VI.")
